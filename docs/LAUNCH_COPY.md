...
PD 5 is for feature work that needs tests, build, and post-PR GitHub Codex approval.
...
PD 1: tiny changes
PD 3: normal fixes
PD 5: post-PR GitHub Codex + tests
...
PD 1은 문서와 설정.
PD 3은 일반 버그 수정.
PD 5는 테스트, 빌드, post-PR GitHub Codex 승인이 필요한 기능 작업.
...
- PD 1: 문서, 설정, 원라이너
- PD 3: 일반 기능 또는 버그 수정
- PD 5: post-PR GitHub Codex 승인, 테스트, 빌드가 필요한 기능 작업
